...
\begin{figure}[h]
\includegraphics[scale=0.7]{WorkingGraph.png}
\centering
...
\item Content per day per participant (\ref{fig:2}).  This can be used in conjunction with the previous graph to view what users have longer messages e.g. two users have similar numbers of messages, but one has far more content indicating more detailed discussion.
...
\begin{itemize}
\item Suggestions for related projects (\ref{fig:3}).  These could be generated by looking at aspects such as what is discussed in the conversations, who takes part in the conversations and what time these conversations were started
