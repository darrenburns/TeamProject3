...
3. Install bower if it is not already present on your system using the command `npm install -g bower`
4. At the root directory of the project, create the database with the following commands:
4.1. `python manage.py migrate core`
4.2. `python manage.py migrate chat`
